...
//
// Vendored from core's src/util/abort.ts: a shipped module's folder is its
// whole world — the installed copy under ~/.modulus/modules has no ../../src
// to import from, and AbortSignal composition is generic plumbing, not a Host
// capability.
//
